...
V4 Trendcenter:
- Separate sidebar page: pages/0_Trendcenter.py
- Own uploads, independent of Lag/Match/Spelare/Målvakt
- Upload saved trend database or many single-match reports
- Builds trend database in session
- Exports updated trend database
- Trend graph with all/latest 3/latest 5/latest 10/custom date interval
- Match history tab
- Improved date parsing for Wed_Mar_04_2026 format
